...
y_out(4,1) = [-y_out(3,1) -y_out(2,1) -y_out(1,1) 0 u_in(3,1) u_in(2,1) u_in(1,1) 0]*theta+NOISE(4,1);
...
theta_hat = zeros(q,1); P = 0; phi_t = zeros(1,q); PHI_T = zeros(Samples,q); L = 1; E = 10; LF = 0; e = 0; e_param = 0;
...
for L=2:Samples
    ...
    e = e+(LF^2);
    e_param = e_param+(a_1_hat(L,1)-a_1)^2+(a_2_hat(L,1)-a_2)^2+(a_3_hat(L,1)-a_3)^2+(a_4_hat(L,1)-a_4)^2+...
