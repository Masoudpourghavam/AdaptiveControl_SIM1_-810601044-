...
a_1_hat = 20*ones(Samples,1); a_2_hat = 20*ones(Samples,1);
a_3_hat = 20*ones(Samples,1); a_4_hat = 20*ones(Samples,1);
b_1_hat = 20*ones(Samples,1); b_2_hat = 20*ones(Samples,1);
b_3_hat = 20*ones(Samples,1); b_4_hat = 20*ones(Samples,1);
